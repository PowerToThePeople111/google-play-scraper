...
function applyCon(pool, conIdx, tor){
  console.log("Called applyCon with => conIdx: " + conIdx + " - tor: " + tor);
  console.log("Called applyCon with pool => " + pool);
  var aCon = pool[conIdx];
  console.log("Called applyCon with aCon => " + aCon);
  console.log("Called applyCon with setTorAddress => " + parseInt(aCon.socksPort));
  console.log("Called applyCon with TorControlPort => " + parseInt(aCon.controlPort));
  ...
  console.log(aCon.socksPort + " - " + aCon.controlPort);
  printTOR_IP(tor);
  
  return tor;
};

var printTOR_IP = function (tor) {
